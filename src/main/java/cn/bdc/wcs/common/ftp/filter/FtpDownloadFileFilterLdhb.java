...
@Component
public class FtpDownloadFileFilterLdhb implements GenericFileFilter<Object> {

    private static Logger logger = LoggerFactory.getLogger(FtpDownloadFileFilterLdhb.class);
