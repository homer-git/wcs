...
@Component
public class FtpDownloadFileFilterDstq implements GenericFileFilter<Object> {

    private static Logger logger = LoggerFactory.getLogger(FtpDownloadFileFilterDstq.class);
