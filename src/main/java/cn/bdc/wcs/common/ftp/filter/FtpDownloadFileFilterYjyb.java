...
@Component
public class FtpDownloadFileFilterYjyb implements GenericFileFilter<Object> {

    private static Logger logger = LoggerFactory.getLogger(FtpDownloadFileFilterYjyb.class);
